...
exports.avatarURL = exports.errorCodes = exports.messages = void 0;
exports.messages = {
...
exports.avatarURL = "https://firebasestorage.googleapis.com/v0/b/gepetoservices.appspot.com/o/user_image.png?alt=media&token=be333301-d240-47cf-9105-831881fe10ba";
function response(error, message, extras) {
    const response = Object.assign({ error: error === false ? [error] : [error, exports.errorCodes[message]], message: exports.messages[message] }, extras);
    return response;
}
